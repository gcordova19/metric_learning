...
def get_path_and_extension(dataset_name):
    if dataset_name=='lfw':
        path = '/home/grupo09/M5/exercise_deep_metric_learning/datasets/lfwcrop_color_by_dirs/'
        extension = 'ppm'
    elif dataset_name=='tsinghua':
        path = '/home/grupo09/M5/exercise_deep_metric_learning/datasets/tsinghua_resized/'
        extension = 'png'
    else:
        assert False
...
image_size = 64
margin = 1.0
type_loss = 'contrastive' # 'contrastive','triplet'
...
What to do 
"""
make_new_split = False #False
seed = 0
""" set a different seed each time to get a new split """
train = True
compute_and_plot_embedding = True # False
if compute_and_plot_embedding:
    ...
    #dim_embedding = 64
    #path_experiment = 'experiments/Mon_Apr__1_23_19_04_2019'
