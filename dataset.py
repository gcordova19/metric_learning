...
if __name__ == '__main__':
    ...
    if dataset_name == 'lfw':
        path_dataset = '/home/grupo09/M5/exercise_deep_metric_learning/datasets/lfwcrop_color_by_dirs/'
        #path_dataset = '/home/joans/Documents/exercise_deep metric_learning/datasets/lfwcrop_color_by_dirs/'
        image_extension = 'ppm'
    elif dataset_name == 'tsinghua':
        path_dataset = '/home/grupo09/M5/exercise_deep_metric_learning/datasets/tsinghua_resized/'
        image_extension = 'png'
    else:
        assert False
